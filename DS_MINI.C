...
int main()
{
  ...
  // printf("\t\t\t\tWELCOME TO QUIZ\n\n");
    ...
    strcpy(option3,"C.  12");
    strcpy(option4,"D.  9");
    root = create(ques,'B',option1,option2,option3,option4,5);
    ...
    root = create(ques,B,option1,option2,option3,option4,);
	root = insert( root, ptr );
    ...
    root = create(ques,C,option1,option2,option3,option4,);
root = insert( root, ptr );
    ...
    root = create(ques,D,option1,option2,option3,option4,);
root = insert( root, ptr );
...
root = insert( root, ptr );
    ...
    root = create(ques,A,option1,option2,option3,option4,);
root = insert( root, ptr );
